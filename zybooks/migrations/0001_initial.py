    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_token', models.CharField(max_length=7, null=True, unique=True)),
                ('course_name', models.CharField(max_length=100)),
                ('start_date', models.DateField(default=django.utils.timezone.now)),
                ('end_date', models.DateField(blank=True, null=True)),
                ('course_type', models.CharField(choices=[('active', 'Active'), ('evaluation', 'Evaluation')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('faculty', 'Faculty'), ('ta', 'Teaching Assistant'), ('student', 'Student')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('block_type', models.CharField(blank=True, choices=[('text', 'Text'), ('image', 'Image'), ('activities', 'Activities')], max_length=10)),
        ...
        migrations.AddField(
            model_name='content',
            name='section',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='zybooks.section'),
        ),
        migrations.CreateModel(
            name='Textbook',
            fields=[
                ('textbook_id', models.PositiveIntegerField(primary_key=True, serialize=False)),
                ('title', models.CharField(max_length=100)),
                ('course', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='zybooks.course')),
            ],
        ),
        migrations.AddField(
            model_name='section',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hourly_pay', models.DecimalField(blank=True, decimal_places=2, default=0.0, max_digits=5)),
                ('hours_per_week', models.PositiveIntegerField(blank=True, null=True)),
                ('associated_faculty', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tas', to='zybooks.user')),
                ('ta', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ta_name', to='zybooks.user')),
            ],
        ),
        migrations.CreateModel(
            name='Notification',
